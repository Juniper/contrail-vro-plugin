...
const val removeSubnetFromVirtualNetwork = "Remove subnet from Virtual network"
const val addSubnetToVirtualNetwork = "Add subnet to virtual network"
const val addSubnetToAddressGroup = "Add subnet to address group"
const val removeSubnetFromAddressGroup = "Remove subnet from address group"