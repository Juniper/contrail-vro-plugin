...
interface NetworkPolicyRuleProperties {
    ...
    fun NetworkPolicy.ruleAddressPropertyVirtualNetwork(
        ruleString: String,
        useDstAddressType: Boolean
    ): VirtualNetwork?

    fun NetworkPolicy.ruleAddressPropertyNetworkPolicy(
        ruleString: String,
        useDstAddressType: Boolean
    ): NetworkPolicy?

    fun NetworkPolicy.ruleAddressPropertySecurityGroup(
        ruleString: String,
        useDstAddressType: Boolean
    ): SecurityGroup?
...
open class NetworkPolicyRulePropertyExecutor(private val connection: Connection) : NetworkPolicyRuleProperties {
    ...
    override fun NetworkPolicy.ruleAddressPropertyVirtualNetwork(
        ruleString: String,
        useDstAddressType: Boolean
    ): VirtualNetwork? {
        val address = extractAddressType(ruleString, useDstAddressType)
    ...
    override fun NetworkPolicy.ruleAddressPropertyNetworkPolicy(
        ruleString: String,
        useDstAddressType: Boolean
    ): NetworkPolicy? {
        val address = extractAddressType(ruleString, useDstAddressType)
    ...
    override fun NetworkPolicy.ruleAddressPropertySecurityGroup(
        ruleString: String,
        useDstAddressType: Boolean
    ): SecurityGroup? {
        val address = extractAddressType(ruleString, useDstAddressType)
