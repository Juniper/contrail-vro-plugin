...
class Utils {
    ...
    fun isNetworkFlat(network: VirtualNetwork): Boolean =
        network.addressAllocationMode == "flat-subnet-only"

    fun isNetworkUserDefined(network: VirtualNetwork): Boolean =
        network.addressAllocationMode == "user-defined-subnet-only"
