...
object Generator {
    @JvmStatic fun main(args: Array<String>) {
        ...
        val simpleWorkflows = generateSimpleWorkflows(globalProjectInfo, defaultSchema, config)
        generateModelAndSchemaInfo(globalProjectInfo, defaultSchema, config)
        generateCustomWorkflowsAndCustomActions(globalProjectInfo, defaultSchema, config, simpleWorkflows)
    }
}
