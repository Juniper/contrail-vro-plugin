...
class SecurityScopeValidationSpec extends WorkflowSpec implements ValidationAsserts {
    ...
    def "Validating a non-draft Service Group when creating a draft Firewall Rule" () {
        given:
        def children = project1ServiceGroup
    ...
    def "Validating a project-scope Service Group when editing a draft project-scope firewall rule" () {
        given:
        def children = project1ServiceGroup
