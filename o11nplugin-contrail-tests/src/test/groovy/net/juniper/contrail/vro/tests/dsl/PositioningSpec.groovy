...
import spock.lang.Specification
    ...
    def "workflow items in simple workflow are placed on the one line"() {
        ...
        then: "the workflow items have the same vertical position"
            ...
            scriptY == TestUtilsKt.visualDefaultVerticalPosition(WorkflowItemType.task, WorkflowBuilderKt.defaultY).toString()
            endY == TestUtilsKt.visualDefaultVerticalPosition(WorkflowItemType.end, WorkflowBuilderKt.defaultY).toString()
