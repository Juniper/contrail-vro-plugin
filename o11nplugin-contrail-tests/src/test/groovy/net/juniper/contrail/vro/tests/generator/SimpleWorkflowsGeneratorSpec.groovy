...
class SimpleWorkflowsGeneratorSpec extends Specification{
    def "expected simple workflows are generated"() {
        ...
        def generatedWorkflows = WorkflowGeneratorKt.generateSimpleWorkflows(ProjectInfoKt.globalProjectInfo, relations, SchemaKt.defaultSchema, TestConfigKt.getTestConfig())
