...
class RemoveSubnetFromAddressGroupSpec extends WorkflowSpec {
    ...
    def addSubnetToAddressGroup = getWorkflowScript("Add subnet to address group")
    def removeSubnetFromAddressGroup = getWorkflowScript("Remove subnet from address group")
