...
import net.juniper.contrail.vro.workflows.model.filterNot
...
class ComplexWorkflowBuilder(
    ...
    fun workflowInvokation(itemId: Int, workflowPackage: String, workflowName: String, outItemId: Int, inputMapping: Map<String, String>, outputMapping: Map<String, String>) {
        ...
        val newOutputAttributes = outputParams.map { it.toParameterInfo() }.map { Attribute(attributeName(attributePrefix, it.name), it.type, it.description) }
        ...
        // TODO: This can remove params that visibility conditions depend on.
        val presentation = definition.presentation.filterNot(inputMapping.keys.toList())
