...
fun inputWorkflowItem(id: Int, inBinding: Binding, outBinding: Binding, outId: Int) =
    WorkflowItem(id, WorkflowItemType.input, somePosition, "User interaction", null, inBinding, outBinding, outId, null, Presentation(
        outBinding.binds.map { PresentationParameter(it.name) }
    ))
