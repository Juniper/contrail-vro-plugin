...
// TODO: displayName
fun workflowWorkflowItem(id: Int, workflowId: String, inBinding: Binding, outBinding: Binding, outId: Int) =
...
fun inputWorkflowItem(id: Int, inBinding: Binding, outBinding: Binding, outId: Int, parameterDefinitions: ParameterAggregator.() -> Unit): WorkflowItem {
    ...
    val presentation = Presentation(parameters.map { it.asPresentationParameter })
