...
fun WorkflowDefinition.withComplexParameters(rootItemId: Int, setup: ComplexParameterDefinition): WorkflowDefinition {
    if (!workflowItems.isEmpty())
    ...
    val builder = ComplexWorkflowBuilder(items, attributes).apply(setup)
    items.add(END)
