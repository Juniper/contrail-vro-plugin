...
internal fun createPolicyManagementFirewallRule(schema: Schema): WorkflowDefinition =
    customWorkflow<FirewallRule>(createWorkflowName<PolicyManagement, FirewallRule>()).withScriptFile("createFirewallRule") {
        step("Parent") {
...
internal fun createProjectFirewallRule(schema: Schema): WorkflowDefinition =
    customWorkflow<FirewallRule>(createWorkflowName<Project, FirewallRule>(hasRootParents = true)).withScriptFile("createFirewallRule") {
        step("Parent") {
