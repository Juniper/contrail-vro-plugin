...
import net.juniper.contrail.vro.config.hasReferenceTo
...
fun ReferenceParameterBuilder.hasReferenceTo(parentField: String) =
    validationActionCallTo(hasReferenceTo).parameter(parentField).asValidationCondition()
